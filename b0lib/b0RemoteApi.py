...
class RemoteApiClient:
    def __init__(self,nodeName='b0RemoteApi_pythonClient',channelName='b0RemoteApi',inactivityToleranceInSec=60,setupSubscribersAsynchronously=False,timeout=3):
        ...
        print('  Initializing...\n')
        """
        print('\n  Запуск B0-Remote-API клиента с названием канала ['+channelName+']')
        print('  убедитесь, что:  1) B0-resolver запущен')
        print('                   2) В настройках B0-Remote-API со стороны CoppeliaSim указано название канала ['+channelName+']')
        print('  Установка связи...')
